...
All fishing effort and capture results are current as of `r Sys.Date()`.

## Fish capture

Since initiation of fieldwork in summer 2021:

-   We have conducted a total of `r n_events` sampling events at `r n_sites_total` unique sites. See the project map in the Methods section ("[Site selection](##%20Site%20selection)") for a current summary of where and sampling events have occurred.

    -   Table \@ref(tab:site-visits) summarises total site visits by individual site. We typically sampled a site only one time, with the exception of two sites: "Lower Soldotna Creek", and "Soldotna Creek Parcel." Both of these sites are highlighted in further detail in the "Discussion" section.
