...
```{r salamatof-creek, echo = F, fig.cap = "Salamatof Creek drainange, North of Kenai, Alaska.", out.width=400, out.height=400}

knitr::include_graphics('images/salamatof_map.jpg')
